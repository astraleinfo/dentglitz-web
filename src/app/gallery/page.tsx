...
const galleryItems = media.galleryItems;
  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#071224] via-[#0d1f3c] to-[#0a2420] pt-32 pb-16 lg:py-28">
        ...
        <div className="pointer-events-none absolute inset-y-0 right-0 w-1/3 overflow-hidden opacity-20 lg:opacity-30">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={media.gallery[0]} alt="" className="h-full w-full object-cover" loading="lazy" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#071224] to-transparent" />
        </div>
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#4DD4C5]/25 bg-[#4DD4C5]/10 px-4 py-1.5">
            ...
            <span className="text-[11px] font-bold uppercase tracking-[0.18em] text-[#4DD4C5]">Photo Gallery</span>
          </div>
          <h1
          ...
          <p className="max-w-xl text-lg text-white/60">
            Browse through our clinic spaces, treatment rooms, equipment, and the happy faces of our patients.
          </p>
          <p className="mt-3 text-sm text-white/35">{galleryItems.length} photos across {categories.length - 1} categories</p>
        </div>
      </section>
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8">
          ...
          {/* Grid */}
          <div className="grid auto-rows-[150px] grid-cols-2 gap-3 sm:auto-rows-[180px] sm:gap-4 md:grid-cols-3 lg:auto-rows-[200px] lg:grid-cols-4">
            {filtered.map((item, i) => (
              <div
                key={item.label + i}
                className="reveal-zoom group relative cursor-pointer overflow-hidden rounded-2xl border border-white/80 shadow-[0_2px_16px_rgba(0,0,0,0.06)] transition-all duration-300 hover:border-[#1e9b8d]/25 hover:shadow-[0_12px_40px_rgba(30,155,141,0.12)]"
              ...
              >
                <Image
                  ...
                  priority={i < 4}
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#071224]/80 via-[#071224]/20 to-transparent opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
              ...
              <div className="flex gap-1.5">
                {filtered.map((_, i) => (
                  <button
                    ...
                    className={`rounded-full transition-all duration-300 ${i === lightboxIndex ? "h-2 w-5 bg-[#1e9b8d]" : "h-2 w-2 bg-slate-200 hover:bg-[#1e9b8d]/40"}`}
                  />
                ))}
              </div>
              <button
